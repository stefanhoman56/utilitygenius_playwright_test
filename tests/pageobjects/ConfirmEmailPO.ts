...
export class ConfirmEmailPO {
  ...
  constructor(page: Page) {
    ...
    this.emailSubmitBtn = page.locator(
    ...
    this.mail = this.inboxFrame.locator('text="UtilityGenius" >> nth=0');
    this.confirmEmailLink = this.emailFrame.locator(
      'text="Confirm my account"'
    );
    this.confirmAccountCreation = page.locator(
      "text='You’re all set! Your account has been verified.'"
    );
