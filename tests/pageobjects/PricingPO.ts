...
export class PricingPO {
  ...
  constructor(page: Page) {
    this.page = page;
    this.pricingLink = page.locator("text='Pricing' >> nth=0");
    this.headerText = page.locator(
      ".entry-content > div > div > div:nth-child(1) h1"
    );
    this.getStartedButton = page.locator("//a[text()='Get Started']");
    this.createFreeAccountButton = page.locator(
      "//a[text()='Create Your Free Account']"
    );
  ...
  async clickOnBuyNowButton() {
    ...
    await this.page.waitForURL("https://utilitygenius.com/cart/");
  }
}
