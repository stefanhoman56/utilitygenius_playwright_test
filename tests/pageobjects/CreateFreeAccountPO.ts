...
export class CreateFreeAccountPO {
  ...
  constructor(page: Page) {
    ...
    this.createFreeAccountBtn = page.locator(
      "//a[contains(text(),'Create Free Account')] >> nth=0"
    );
    this.googleSignupBtn = page.locator(
      "//div[@class='auth0-lock-social-button-text'] >> nth=0"
    );
  }
